function [exitflag, output_msg] = call_output_fun(output_fun, state, iter, action, X, f, fcount, exitflag, output_msg)
% -- [exitflag, output_msg] = call_output_fun(output_fun, state, iter, action, X, f, fcount, exitflag, output_msg)
%
