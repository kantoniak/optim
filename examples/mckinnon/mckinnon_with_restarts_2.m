% This presents McKinnon example #2 of function which usually stagnates at the
...
[x, fval, exitflag, output] = run_mckinnon_example(2, 6, 60, 'out/mckinnon-with-restarts-2.tex', 10);
