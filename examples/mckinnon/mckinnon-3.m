...
plot_options = struct();
plot_options.title = 'McKinnon Example for $ \tau = 3 $, $ \theta = 6 $, $ \phi = 400 $';
...
plot_options.print_path = 'out/mckinnon-3.tex';
...
[x, fval, exitflag, output] = fminsearch_nm(mckinnon_f3, initial_point, options);
