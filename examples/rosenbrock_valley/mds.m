% This presents sample MDS iterations on Rosenbrock valley function.
...
[x, fval, exitflag, output] = fminsearch_mds(@(x) rosenbrock_func(x, 1, 100), initial_point, options);
