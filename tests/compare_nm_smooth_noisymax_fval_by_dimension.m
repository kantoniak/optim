...
optimizers(1).display_name = 'funkcja testowa';
...
for d=1:dimension_count
    ...
    if (dim == 12)
        ...
        plot_options(3).y_ticks = [1E-8 1E-6 1E-4 1E-2 1 1E+2];
        plot_options(6).y_ticks = [1E-4 1E-2 1 1E+2 1E+4 1E+6];
    end

    % Printing
    print_options = struct();
    print_options.print_path = sprintf('out/compare_nm_smooth_noisymax_fval_by_dimension_r%d.tex', dim);
