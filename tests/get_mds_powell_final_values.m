% Configuration
output_filename = 'out/mds_powell_final_values.tex';
...
for d=1:dimension_count
    ...
    % Print line
    fprintf(file, '%d & \\multicolumn{1}{r|}{%d} & \\multicolumn{1}{r|}{%f} & \\multicolumn{1}{r|}{%f}', dim, iters, x_norm, fval);
    fprintf(file, ' \\\\ \\hline\n');
